...
pub fn print_add_step(label: &str) {
    print_step(label, &symbol_add());
}

pub fn print_remove_step(label: &str) {
    print_step(label, &symbol_remove());
}

pub fn print_change_step(label: &str) {
    print_step(label, &symbol_change());
}
